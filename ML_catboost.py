...
print("--- Optimized CatBoost Script ---")
...
cat_features = ['Age_Group']  # Keep categorical handling native
...
print("\n" + "="*50)
print(f" Optimized CatBoost - Final Mean Absolute Error (MAE): {final_mae:.4f} kcal")
print("="*50)